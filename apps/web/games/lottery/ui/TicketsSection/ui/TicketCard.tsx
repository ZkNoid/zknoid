...
export default function TicketCard({
  ...
  return (
    <div className="relative h-[13.53vw] w-[24vw] rounded-[1.33vw] bg-right-accent p-[0.33vw]">
      <div className="flex h-full w-full flex-col rounded-[1.042vw] border border-bg-dark p-[1.33vw]">
          ...
          <div className="ml-auto flex gap-[0.33vw] text-[1.07vw] text-right-accent">
            {amount == 0 ? (
              ...
              <div className={'flex flex-row gap-[0.26vw]'}>
                <TicketBlockButton onClick={() => setSymbols('')}>
                  <svg
                    width="0.885vw"
                    height="0.885vw"
                    viewBox="0 0 17 18"
