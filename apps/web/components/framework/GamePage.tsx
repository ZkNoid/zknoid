...
export function TabsSwitch({
  ...
  return (
    <div className={'absolute -left-[2px] -top-[4vw] flex w-fit flex-row'}>
      ...
      {competitionsSupported && (
        <div
          className={'relative -ml-[4.167vw] w-[20vw] first:ml-0'}
    ...
    <div className={'px-[2.604vw]'}>
      {useTitle &&
        (customGameTitle ? (
          ...
          <div
            className={cn(
              'h-[15.625vw] w-full overflow-hidden rounded-[1.042vw] border-2 border-left-accent',
          ...
          >
            <Image
              ...
              alt={'gameImage'}
              className={
                'h-full w-full rounded-[0.781vw] object-cover object-center'
              }
            />
          </div>
        ))}
