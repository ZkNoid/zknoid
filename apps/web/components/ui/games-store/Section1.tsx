    ...
    <>
      <div className="banner-mask relative">
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute pointer-events-none bottom-0 top-0 h-full w-full z-40 hidden lg:block"
        >
          <path
        ...
        <div className="absolute left-0 top-0 h-full w-full hidden lg:block">
