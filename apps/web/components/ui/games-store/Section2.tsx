...
export const Section2 = ({ games }: { games: IGame[] }) => {
  ...
  const SwitchBtn = ({
    ...
    return (
      ...
      >
        <div
          className={
            'absolute left-0 top-0 -z-20 hidden h-full w-full lg:block'
          }
        >
          <svg
            width="307"
        ...
        <div
          className={
            'flex h-[3.188vw] w-full items-center gap-[0.838vw] pl-[1.775vw] '
          }
        >
  ...
  const WidgetsSwitch = () => {
    return (
      <div
        className={'mt-auto flex flex-col lg:flex-row'}
      ...
      >
        ...
        <SwitchBtn
          ...
          className={'ml-[-3.125vw] w-[19.063vw]'}
          startContent={(selected) => (
            <svg
              width="32"
              height="29"
