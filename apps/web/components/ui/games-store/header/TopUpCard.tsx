  ...
  return (
    <div
      className={cn(
        ...
        'text-foreground transition duration-75 ease-in hover:border-middle-accent',
    ...
    >
      <TopUpSVG
        className={cn(
          'h-[24px] w-[24px] fill-white group-hover:fill-middle-accent',
          expanded && 'fill-middle-accent'
        )}
      />
      {text}
    </div>
